...
| `void and_mint_manually (mint*, mint*, mint* output)` | write to third argument what is calculation result of `AND` by first two arguments. if third argument dose not have enough space, part of data will be missing. | 
| `void or_mint_manually (mint*, mint*, mint* output)` | write to third argument what is calculation result of `OR` by first two arguments. if third argument dose not have enough space, part of data will be missing. | 
| `void xor_mint_manually (mint*, mint*, mint* output)` | write to third argument what is calculation result of `XOR` by first two arguments. if third argument dose not have enough space, part of data will be missing. |
| `void not_mint_manually (mint*, mint*, mint* output)` | write to second argument what is calculation result of `NOT` by first arguments. if second argument dose not have enough space, part of data will be missing. | 
| `void add_mint_manually (mint*, mint*, mint* output)` | write to second argument what is calculation result of `+` by first arguments. if second argument dose not have enough space, part of data will be missing. |
...
| `int is_greater_mint (mint*, mint*)` | return a integer that is `1` if first argument is greater than second argument, otherwise `0`. | 
| `int is_greater_or_equal_mint (mint*, mint*)` | return a integer that is `1` if first argument is greater or equal than second argument, otherwise `0`. | 
| `int is_lesser_mint (mint*, mint*)` | return a integer that is `1` if first argument is lesser than second argument, otherwise `0`. | 
| `int is_lesser_or_equal_mint (mint*, mint*)` | return a integer that is `1` if first argument is lesser or equal than second argument, otherwise `0`. | 
| `int is_unequal_mint (mint*, mint*)` | return a integer that is `1` if two arguments is not equal, otherwise `0`. | 
| `int is_zero_mint (mint*)` | return a integer that is `1` if argument is `0`, otherwise `0`. |
...
| `mint *lshift_mint (mint*, mint* count)` | return a calculation result of arithmetic left shift by last two arguments. *becareful!* `count` has not supported negative number. |
| `mint *rshift_mint (mint*, mint* count)` | return a calculation result of arithmetic right shift by last two arguments. *becareful!* `count` has not supported negative number. |
...
| `lshift_tmp_mint (var, mint*, mint* count)` | assign a new instance from stack frame to `var`. that is a calculation result of arithmetic left shift by last two arguments. *becareful!* `count` has not supported negative number. |
| `rshift_tmp_mint (var, mint*, mint* count)` | assign a new instance from stack frame to `var`. that is a calculation result of arithmetic right shift by last two arguments. *becareful!* `count` has not supported negative number. |
